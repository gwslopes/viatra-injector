...
public final class WvavcguardSpecification extends BaseGeneratedEMFQuerySpecification<WvavcguardSpecification.Matcher> {
  /**
   * Pattern-specific match representation of the br.unicamp.ic.laser.viatrainjector.wvavcguardSpecification pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private ControlFlow fGuard;
    
    private String fStr;
    
    private static List<String> parameterNames = makeImmutableList("act", "c", "guard", "str");
    
    private Match(final Activity pAct, final Comment pC, final ControlFlow pGuard, final String pStr) {
      this.fAct = pAct;
      this.fC = pC;
      this.fGuard = pGuard;
      this.fStr = pStr;
    ...
    public boolean set(final String parameterName, final Object newValue) {
      ...
      if ("guard".equals(parameterName) ) {
          this.fGuard = (ControlFlow) newValue;
          return true;
      }
    ...
    public void setGuard(final ControlFlow pGuard) {
      if (!isMutable()) throw new java.lang.UnsupportedOperationException();
      this.fGuard = pGuard;
    }
    ...
    public String patternName() {
      return "br.unicamp.ic.laser.viatrainjector.wvavcguardSpecification";
    }
    
    @Override
    public List<String> parameterNames() {
      return WvavcguardSpecification.Match.parameterNames;
    }
    ...
    @Override
    public WvavcguardSpecification.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WvavcguardSpecification.Match)) {
          WvavcguardSpecification.Match other = (WvavcguardSpecification.Match) obj;
    ...
    @Override
    public WvavcguardSpecification specification() {
     ...
     * 
     */
    public static WvavcguardSpecification.Match newEmptyMatch() {
     ...
     * 
     */
    public static WvavcguardSpecification.Match newMutableMatch(final Activity pAct, final Comment pC, final ControlFlow pGuard, final String pStr) {
     ...
     * 
     */
    public static WvavcguardSpecification.Match newMatch(final Activity pAct, final Comment pC, final ControlFlow pGuard, final String pStr) {
      return new Immutable(pAct, pC, pGuard, pStr);
    }
    
    private static final class Mutable extends WvavcguardSpecification.Match {
      Mutable(final Activity pAct, final Comment pC, final ControlFlow pGuard, final String pStr) {
    ...
    private static final class Immutable extends WvavcguardSpecification.Match {
      Immutable(final Activity pAct, final Comment pC, final ControlFlow pGuard, final String pStr) {
        super(pAct, pC, pGuard, pStr);
      }
  ...
  /**
   * Generated pattern matcher API of the br.unicamp.ic.laser.viatrainjector.wvavcguardSpecification pattern,
   ...
   * 
   * @see Match
   * @see WvavcguardSpecification
   * 
   */
  public static class Matcher extends BaseMatcher<WvavcguardSpecification.Match> {
    /**
     ...
     * 
     */
    public static WvavcguardSpecification.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WvavcguardSpecification.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WvavcguardSpecification.Matcher.class);
     ...
     * 
     */
    public Collection<WvavcguardSpecification.Match> getAllMatches(final Activity pAct, final Comment pC, final ControlFlow pGuard, final String pStr) {
     ...
     * 
     */
    public Stream<WvavcguardSpecification.Match> streamAllMatches(final Activity pAct, final Comment pC, final ControlFlow pGuard, final String pStr) {
     ...
     * 
     */
    public Optional<WvavcguardSpecification.Match> getOneArbitraryMatch(final Activity pAct, final Comment pC, final ControlFlow pGuard, final String pStr) {
     ...
     * 
     */
    public boolean hasMatch(final Activity pAct, final Comment pC, final ControlFlow pGuard, final String pStr) {
     ...
     * 
     */
    public int countMatches(final Activity pAct, final Comment pC, final ControlFlow pGuard, final String pStr) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pAct, final Comment pC, final ControlFlow pGuard, final String pStr, final Consumer<? super WvavcguardSpecification.Match> processor) {
     ...
     * 
     */
    public WvavcguardSpecification.Match newMatch(final Activity pAct, final Comment pC, final ControlFlow pGuard, final String pStr) {
      return WvavcguardSpecification.Match.newMatch(pAct, pC, pGuard, pStr);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfact(final WvavcguardSpecification.Match partialMatch) {
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfact(final Comment pC, final ControlFlow pGuard, final String pStr) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfact(final WvavcguardSpecification.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfact(final Comment pC, final ControlFlow pGuard, final String pStr) {
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfc(final WvavcguardSpecification.Match partialMatch) {
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfc(final Activity pAct, final ControlFlow pGuard, final String pStr) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfc(final WvavcguardSpecification.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfc(final Activity pAct, final ControlFlow pGuard, final String pStr) {
     ...
     * 
     */
    protected Stream<ControlFlow> rawStreamAllValuesOfguard(final Object[] parameters) {
      return rawStreamAllValues(POSITION_GUARD, parameters).map(ControlFlow.class::cast);
    }
     ...
     * 
     */
    public Set<ControlFlow> getAllValuesOfguard() {
     ...
     * 
     */
    public Stream<ControlFlow> streamAllValuesOfguard() {
     ...
     * 
     */
    public Stream<ControlFlow> streamAllValuesOfguard(final WvavcguardSpecification.Match partialMatch) {
     ...
     * 
     */
    public Stream<ControlFlow> streamAllValuesOfguard(final Activity pAct, final Comment pC, final String pStr) {
     ...
     * 
     */
    public Set<ControlFlow> getAllValuesOfguard(final WvavcguardSpecification.Match partialMatch) {
     ...
     * 
     */
    public Set<ControlFlow> getAllValuesOfguard(final Activity pAct, final Comment pC, final String pStr) {
     ...
     * 
     */
    public Stream<String> streamAllValuesOfstr(final WvavcguardSpecification.Match partialMatch) {
     ...
     * 
     */
    public Stream<String> streamAllValuesOfstr(final Activity pAct, final Comment pC, final ControlFlow pGuard) {
     ...
     * 
     */
    public Set<String> getAllValuesOfstr(final WvavcguardSpecification.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfstr(final Activity pAct, final Comment pC, final ControlFlow pGuard) {
      return rawStreamAllValuesOfstr(new Object[]{pAct, pC, pGuard, null}).collect(Collectors.toSet());
    }
    
    @Override
    protected WvavcguardSpecification.Match tupleToMatch(final Tuple t) {
      try {
          return WvavcguardSpecification.Match.newMatch((Activity) t.get(POSITION_ACT), (Comment) t.get(POSITION_C), (ControlFlow) t.get(POSITION_GUARD), (String) t.get(POSITION_STR));
    ...
    @Override
    protected WvavcguardSpecification.Match arrayToMatch(final Object[] match) {
      try {
          return WvavcguardSpecification.Match.newMatch((Activity) match[POSITION_ACT], (Comment) match[POSITION_C], (ControlFlow) match[POSITION_GUARD], (String) match[POSITION_STR]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WvavcguardSpecification.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WvavcguardSpecification.Match.newMutableMatch((Activity) match[POSITION_ACT], (Comment) match[POSITION_C], (ControlFlow) match[POSITION_GUARD], (String) match[POSITION_STR]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WvavcguardSpecification.Matcher> querySpecification() {
      return WvavcguardSpecification.instance();
    }
  }
  
  private WvavcguardSpecification() {
   ...
   * 
   */
  public static WvavcguardSpecification instance() {
    try{
  ...
  @Override
  protected WvavcguardSpecification.Matcher instantiate(final ViatraQueryEngine engine) {
    return WvavcguardSpecification.Matcher.on(engine);
  }
  
  @Override
  public WvavcguardSpecification.Matcher instantiate() {
    return WvavcguardSpecification.Matcher.create();
  }
  
  @Override
  public WvavcguardSpecification.Match newEmptyMatch() {
    return WvavcguardSpecification.Match.newEmptyMatch();
  }
  
  @Override
  public WvavcguardSpecification.Match newMatch(final Object... parameters) {
    return WvavcguardSpecification.Match.newMatch((org.eclipse.uml2.uml.Activity) parameters[0], (org.eclipse.uml2.uml.Comment) parameters[1], (org.eclipse.uml2.uml.ControlFlow) parameters[2], (java.lang.String) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WvavcguardSpecification} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WvavcguardSpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WvavcguardSpecification INSTANCE = new WvavcguardSpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WvavcguardSpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final PParameter parameter_guard = new PParameter("guard", "org.eclipse.uml2.uml.ControlFlow", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.eclipse.org/uml2/5.0.0/UML", "ControlFlow")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_guard), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.eclipse.org/uml2/5.0.0/UML", "ControlFlow")));
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public String getShortDescription() {
                  return "Expression evaluation from pattern wvavcguardSpecification";
              }
