 ...
 *         
 *             check (
 *             	str.startsWith("InjectFault into pin") && str.indexOf("MLPA") {@literal >} 0  
 *             );
 *         }
 * </pre></code>
 * 
...
public final class MlpapinSpecification extends BaseGeneratedEMFQuerySpecification<MlpapinSpecification.Matcher> {
  /**
   * Pattern-specific match representation of the br.unicamp.ic.laser.viatrainjector.mlpapinSpecification pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "br.unicamp.ic.laser.viatrainjector.mlpapinSpecification";
    }
    
    @Override
    public List<String> parameterNames() {
      return MlpapinSpecification.Match.parameterNames;
    }
    ...
    @Override
    public MlpapinSpecification.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof MlpapinSpecification.Match)) {
          MlpapinSpecification.Match other = (MlpapinSpecification.Match) obj;
    ...
    @Override
    public MlpapinSpecification specification() {
     ...
     * 
     */
    public static MlpapinSpecification.Match newEmptyMatch() {
     ...
     * 
     */
    public static MlpapinSpecification.Match newMutableMatch(final Activity pAct, final Comment pC, final Pin pPin, final String pStr) {
     ...
     * 
     */
    public static MlpapinSpecification.Match newMatch(final Activity pAct, final Comment pC, final Pin pPin, final String pStr) {
      return new Immutable(pAct, pC, pPin, pStr);
    }
    
    private static final class Mutable extends MlpapinSpecification.Match {
    ...
    private static final class Immutable extends MlpapinSpecification.Match {
  ...
  /**
   * Generated pattern matcher API of the br.unicamp.ic.laser.viatrainjector.mlpapinSpecification pattern,
   ...
   * 
   * @see Match
   * @see MlpapinSpecification
   * 
   */
  public static class Matcher extends BaseMatcher<MlpapinSpecification.Match> {
    /**
     ...
     * 
     */
    public static MlpapinSpecification.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static MlpapinSpecification.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(MlpapinSpecification.Matcher.class);
     ...
     * 
     */
    public Collection<MlpapinSpecification.Match> getAllMatches(final Activity pAct, final Comment pC, final Pin pPin, final String pStr) {
     ...
     * 
     */
    public Stream<MlpapinSpecification.Match> streamAllMatches(final Activity pAct, final Comment pC, final Pin pPin, final String pStr) {
     ...
     * 
     */
    public Optional<MlpapinSpecification.Match> getOneArbitraryMatch(final Activity pAct, final Comment pC, final Pin pPin, final String pStr) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pAct, final Comment pC, final Pin pPin, final String pStr, final Consumer<? super MlpapinSpecification.Match> processor) {
     ...
     * 
     */
    public MlpapinSpecification.Match newMatch(final Activity pAct, final Comment pC, final Pin pPin, final String pStr) {
      return MlpapinSpecification.Match.newMatch(pAct, pC, pPin, pStr);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfact(final MlpapinSpecification.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfact(final MlpapinSpecification.Match partialMatch) {
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfc(final MlpapinSpecification.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfc(final MlpapinSpecification.Match partialMatch) {
     ...
     * 
     */
    public Stream<Pin> streamAllValuesOfpin(final MlpapinSpecification.Match partialMatch) {
     ...
     * 
     */
    public Set<Pin> getAllValuesOfpin(final MlpapinSpecification.Match partialMatch) {
     ...
     * 
     */
    public Stream<String> streamAllValuesOfstr(final MlpapinSpecification.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfstr(final MlpapinSpecification.Match partialMatch) {
    ...
    @Override
    protected MlpapinSpecification.Match tupleToMatch(final Tuple t) {
      try {
          return MlpapinSpecification.Match.newMatch((Activity) t.get(POSITION_ACT), (Comment) t.get(POSITION_C), (Pin) t.get(POSITION_PIN), (String) t.get(POSITION_STR));
    ...
    @Override
    protected MlpapinSpecification.Match arrayToMatch(final Object[] match) {
      try {
          return MlpapinSpecification.Match.newMatch((Activity) match[POSITION_ACT], (Comment) match[POSITION_C], (Pin) match[POSITION_PIN], (String) match[POSITION_STR]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected MlpapinSpecification.Match arrayToMatchMutable(final Object[] match) {
      try {
          return MlpapinSpecification.Match.newMutableMatch((Activity) match[POSITION_ACT], (Comment) match[POSITION_C], (Pin) match[POSITION_PIN], (String) match[POSITION_STR]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<MlpapinSpecification.Matcher> querySpecification() {
      return MlpapinSpecification.instance();
    }
  }
  
  private MlpapinSpecification() {
   ...
   * 
   */
  public static MlpapinSpecification instance() {
    try{
  ...
  @Override
  protected MlpapinSpecification.Matcher instantiate(final ViatraQueryEngine engine) {
    return MlpapinSpecification.Matcher.on(engine);
  }
  
  @Override
  public MlpapinSpecification.Matcher instantiate() {
    return MlpapinSpecification.Matcher.create();
  }
  
  @Override
  public MlpapinSpecification.Match newEmptyMatch() {
    return MlpapinSpecification.Match.newEmptyMatch();
  }
  
  @Override
  public MlpapinSpecification.Match newMatch(final Object... parameters) {
    return MlpapinSpecification.Match.newMatch((org.eclipse.uml2.uml.Activity) parameters[0], (org.eclipse.uml2.uml.Comment) parameters[1], (org.eclipse.uml2.uml.Pin) parameters[2], (java.lang.String) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link MlpapinSpecification} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link MlpapinSpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final MlpapinSpecification INSTANCE = new MlpapinSpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final MlpapinSpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          //     check (    	str.startsWith("InjectFault into pin") && str.indexOf("MLPA") > 0      )
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
          
              @Override
              public String getShortDescription() {
                  return "Expression evaluation from pattern mlpapinSpecification";
              }
  ...
  private static boolean evaluateExpression_1_1(final String str) {
    return (str.startsWith("InjectFault into pin") && (str.indexOf("MLPA") > 0));
  }
}
