...
public final class Wbc1objectSpecification extends BaseGeneratedEMFQuerySpecification<Wbc1objectSpecification.Matcher> {
  /**
   * Pattern-specific match representation of the br.unicamp.ic.laser.viatrainjector.wbc1objectSpecification pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "br.unicamp.ic.laser.viatrainjector.wbc1objectSpecification";
    }
    
    @Override
    public List<String> parameterNames() {
      return Wbc1objectSpecification.Match.parameterNames;
    }
    ...
    @Override
    public Wbc1objectSpecification.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Wbc1objectSpecification.Match)) {
          Wbc1objectSpecification.Match other = (Wbc1objectSpecification.Match) obj;
    ...
    @Override
    public Wbc1objectSpecification specification() {
     ...
     * 
     */
    public static Wbc1objectSpecification.Match newEmptyMatch() {
     ...
     * 
     */
    public static Wbc1objectSpecification.Match newMutableMatch(final Activity pAct, final Comment pC, final ObjectFlow pObjflow, final String pStr) {
     ...
     * 
     */
    public static Wbc1objectSpecification.Match newMatch(final Activity pAct, final Comment pC, final ObjectFlow pObjflow, final String pStr) {
      return new Immutable(pAct, pC, pObjflow, pStr);
    }
    
    private static final class Mutable extends Wbc1objectSpecification.Match {
    ...
    private static final class Immutable extends Wbc1objectSpecification.Match {
  ...
  /**
   * Generated pattern matcher API of the br.unicamp.ic.laser.viatrainjector.wbc1objectSpecification pattern,
   ...
   * 
   * @see Match
   * @see Wbc1objectSpecification
   * 
   */
  public static class Matcher extends BaseMatcher<Wbc1objectSpecification.Match> {
    /**
     ...
     * 
     */
    public static Wbc1objectSpecification.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Wbc1objectSpecification.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Wbc1objectSpecification.Matcher.class);
     ...
     * 
     */
    public Collection<Wbc1objectSpecification.Match> getAllMatches(final Activity pAct, final Comment pC, final ObjectFlow pObjflow, final String pStr) {
     ...
     * 
     */
    public Stream<Wbc1objectSpecification.Match> streamAllMatches(final Activity pAct, final Comment pC, final ObjectFlow pObjflow, final String pStr) {
     ...
     * 
     */
    public Optional<Wbc1objectSpecification.Match> getOneArbitraryMatch(final Activity pAct, final Comment pC, final ObjectFlow pObjflow, final String pStr) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pAct, final Comment pC, final ObjectFlow pObjflow, final String pStr, final Consumer<? super Wbc1objectSpecification.Match> processor) {
     ...
     * 
     */
    public Wbc1objectSpecification.Match newMatch(final Activity pAct, final Comment pC, final ObjectFlow pObjflow, final String pStr) {
      return Wbc1objectSpecification.Match.newMatch(pAct, pC, pObjflow, pStr);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfact(final Wbc1objectSpecification.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfact(final Wbc1objectSpecification.Match partialMatch) {
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfc(final Wbc1objectSpecification.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfc(final Wbc1objectSpecification.Match partialMatch) {
     ...
     * 
     */
    public Stream<ObjectFlow> streamAllValuesOfobjflow(final Wbc1objectSpecification.Match partialMatch) {
     ...
     * 
     */
    public Set<ObjectFlow> getAllValuesOfobjflow(final Wbc1objectSpecification.Match partialMatch) {
     ...
     * 
     */
    public Stream<String> streamAllValuesOfstr(final Wbc1objectSpecification.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfstr(final Wbc1objectSpecification.Match partialMatch) {
    ...
    @Override
    protected Wbc1objectSpecification.Match tupleToMatch(final Tuple t) {
      try {
          return Wbc1objectSpecification.Match.newMatch((Activity) t.get(POSITION_ACT), (Comment) t.get(POSITION_C), (ObjectFlow) t.get(POSITION_OBJFLOW), (String) t.get(POSITION_STR));
    ...
    @Override
    protected Wbc1objectSpecification.Match arrayToMatch(final Object[] match) {
      try {
          return Wbc1objectSpecification.Match.newMatch((Activity) match[POSITION_ACT], (Comment) match[POSITION_C], (ObjectFlow) match[POSITION_OBJFLOW], (String) match[POSITION_STR]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Wbc1objectSpecification.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Wbc1objectSpecification.Match.newMutableMatch((Activity) match[POSITION_ACT], (Comment) match[POSITION_C], (ObjectFlow) match[POSITION_OBJFLOW], (String) match[POSITION_STR]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Wbc1objectSpecification.Matcher> querySpecification() {
      return Wbc1objectSpecification.instance();
    }
  }
  
  private Wbc1objectSpecification() {
   ...
   * 
   */
  public static Wbc1objectSpecification instance() {
    try{
  ...
  @Override
  protected Wbc1objectSpecification.Matcher instantiate(final ViatraQueryEngine engine) {
    return Wbc1objectSpecification.Matcher.on(engine);
  }
  
  @Override
  public Wbc1objectSpecification.Matcher instantiate() {
    return Wbc1objectSpecification.Matcher.create();
  }
  
  @Override
  public Wbc1objectSpecification.Match newEmptyMatch() {
    return Wbc1objectSpecification.Match.newEmptyMatch();
  }
  
  @Override
  public Wbc1objectSpecification.Match newMatch(final Object... parameters) {
    return Wbc1objectSpecification.Match.newMatch((org.eclipse.uml2.uml.Activity) parameters[0], (org.eclipse.uml2.uml.Comment) parameters[1], (org.eclipse.uml2.uml.ObjectFlow) parameters[2], (java.lang.String) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Wbc1objectSpecification} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Wbc1objectSpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Wbc1objectSpecification INSTANCE = new Wbc1objectSpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Wbc1objectSpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          //     check (    	str.startsWith("InjectFault into Object flow") && str.indexOf("WBC1") > 0      )
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
          
              @Override
              public String getShortDescription() {
                  return "Expression evaluation from pattern wbc1objectSpecification";
              }
